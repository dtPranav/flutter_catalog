          ...
          children: [
            DrawerHeader(
              ...
              child: UserAccountsDrawerHeader(
                ...
                accountEmail: Text("pra.nan786"),
                margin: EdgeInsets.zero,
                // currentAccountPicture: Image.network(imagevar),
                currentAccountPicture: CircleAvatar(
                  backgroundImage: NetworkImage(imagevar),
                ),
